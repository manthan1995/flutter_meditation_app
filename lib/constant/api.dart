class ApiUrls {
  static const String baseUrl = 'http://54.226.108.109:3000';
  static const String createAccountUrl = '/application/user';
  static const String loginUrl = '/application/user/login';
